                    ...
                    child: Column(children: [
                      ...
                      Container(
                          ...
                          child: Column(children: [
                            ...
                            Container(
                                ...
                                padding: EdgeInsets.symmetric(horizontal: 15),
                                margin: EdgeInsets.only(bottom: 5, top: 15),
                                child: Text('Company name', style: TextStyle(fontSize: 15.0, color: Colors.black54)).tr()),
                            SizedBox(
                                height: getWH(context, 1) * 0.05,
                                child: TextField(
                                    decoration: InputDecoration(
                            ...
                            Container(
                                ...
                                padding: EdgeInsets.symmetric(horizontal: 15),
                                margin: EdgeInsets.only(bottom: 5, top: 15),
                                child: Text('Category', style: TextStyle(fontSize: 15.0, color: Colors.black54)).tr()),
                            SizedBox(
                                height: getWH(context, 1) * 0.05,
                                child: SelectFormField(
                                    decoration: InputDecoration(
                      ...
                      GestureDetector(
                          onTap: () {
                            ...
                            if (company.text.isNotEmpty) filters['company_name_searche'] = company.text;
                            ...
                            if (currency.text.isNotEmpty) filters['currency_searche'] = currency.text;
                            ...
                            if (category.text.isNotEmpty) filters['category_selected_job'] = category.text;
                            filters['type'] = '1';
                            filters['lang'] = lang;
                            Get.to(() => ResultsPage(filters: filters, saved: 1));
                          },
                          child: Container(
                              decoration: BoxDecoration(
                              ...
                              onPressed: () async {
                                if (type == 'Individual' || type == 'Company') {
                                  ...
                                  if (type == 'Company') {
                                    ...
                                    filters['individual_id'] = uid;
                                  }
                                  filters['lang'] = lang;
                                  await saveSearch(context, filters, 1);
                                } else if (type != 'Company') {
                                  Get.to(() => RegisterPage());
                                }
                              },
                              child:
                                  Text("Save search", style: TextStyle(decoration: TextDecoration.underline, color: hexStringToColor('#6986b8'), fontSize: 16))
                                      .tr())
                          : SizedBox(),
                      Container(
                          alignment: Alignment.center,
                          ...
                          child: Column(children: [
                            Text("Selected Jobs", style: TextStyle(fontWeight: FontWeight.bold)).tr(),
                            Divider(),
                              ...
                              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                SizedBox(
                                    ...
                                    child: ElevatedButton(
                                        style: ElevatedButton.styleFrom(primary: hexStringToColor('#6986b8')),
                                        onPressed: () {
                                          Get.to(() => SelectedJobsPage(label: "Freelance", type: '7'));
                                        },
                                        child: const Text('Freelance', textAlign: TextAlign.center, style: TextStyle(color: Colors.white)).tr())),
                                SizedBox(
                                    width: getWH(context, 2) * 0.3,
                                    child: ElevatedButton(
                                        style: ElevatedButton.styleFrom(primary: hexStringToColor('#6986b8')),
                                        onPressed: () {
                                          Get.to(() => SelectedJobsPage(label: "Part-time", type: '8'));
                                        },
                                        child: const Text('Part-time', textAlign: TextAlign.center, style: TextStyle(color: Colors.white)).tr())),
                                SizedBox(
                                    width: getWH(context, 2) * 0.3,
                                    child: ElevatedButton(
                                        style: ElevatedButton.styleFrom(primary: hexStringToColor('#6986b8')),
                                        onPressed: () {
                                          Get.to(() => SelectedJobsPage(label: "Remote Work", type: '9'));
                                        },
                                        child: const Text('Remote Work', textAlign: TextAlign.center, style: TextStyle(color: Colors.white)).tr())),
                              ]),
                              VerticalDivider(),
                              Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                                SizedBox(
                                    ...
                                    child: ElevatedButton(
                                        style: ElevatedButton.styleFrom(primary: hexStringToColor('#6986b8')),
                                        onPressed: () {
                                          Get.to(() => SelectedJobsPage(label: "Recent Graduate", type: '10'));
                                        },
                                        child: const Text('Recent Graduate', textAlign: TextAlign.center, style: TextStyle(color: Colors.white)).tr())),
                                SizedBox(
                                    width: getWH(context, 2) * 0.3,
                                    child: ElevatedButton(
                                        style: ElevatedButton.styleFrom(primary: hexStringToColor('#6986b8')),
                                        onPressed: () {
                                          Get.to(() => SelectedJobsPage(label: "Data Entry", type: '12'));
                                        },
                                        child: const Text('Data Entry', textAlign: TextAlign.center, style: TextStyle(color: Colors.white)).tr())),
                                SizedBox(
                                    width: getWH(context, 2) * 0.3,
                                    child: ElevatedButton(
                                        style: ElevatedButton.styleFrom(primary: hexStringToColor('#6986b8')),
                                        onPressed: () {
                                          Get.to(() => SelectedJobsPage(label: "Women Jobs", type: '13'));
                                        },
                                        child: const Text('Women Jobs', textAlign: TextAlign.center, style: TextStyle(color: Colors.white)).tr()))
                              ])
                            ]),
                            ElevatedButton(
                                style: ElevatedButton.styleFrom(primary: hexStringToColor('#6986b8')),
                                onPressed: () {
                                  Get.to(() => SelectedJobsPage(label: "Contract Jobs", type: '11'));
                                },
                                child: const Text('Contract Jobs', textAlign: TextAlign.center, style: TextStyle(color: Colors.white)).tr())
                          ]))
                    ]));
              })));
...
class ResultsPage extends StatefulWidget {
  const ResultsPage({Key? key, required this.filters, required this.saved}) : super(key: key);
                ...
                children: [
                    SpeedDialChild(
                        ...
                        onTap: () async {
                          ...
                          review["individual_id"] = globalUid;
                          await commentDialog(context, globalType, 'search review', lang, globalUid, '', '', review);
                        })
                  ])
            : SizedBox(),
        appBar: AppBar(
                                ...
                                return GestureDetector(
                                    onTap: () async {
                                      if (globalType == 'Individual') {
                                        Get.to(() => IndividualJobPage(jobId: j[index]['id'].toString(), jobType: 'Normal Job'));
                                    ...
                                    child: Column(children: [
                                      ...
                                      globalType == 'Individual' && j[index]['suitability'] != null
                                          ? Stack(alignment: Alignment.center, children: <Widget>[
                                              ...
                                              Align(
                                                  child: Text(tr('Suitability - ') + j[index]['suitability'].toString() + '% ',
