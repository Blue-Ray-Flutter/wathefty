...
import 'package:wathefty/Pages/company/event_page.dart';
...
class ViewCompany extends StatefulWidget {
  ...
  const ViewCompany({Key? key, required this.companyId}) : super(key: key);
...
class _ViewCompanyState extends State<ViewCompany> {
  ...
  Widget build(BuildContext context) => FutureBuilder<Map>(
      future: getOtherProfile('Individual', context.locale.toString(), widget.companyId),
                    ...
                    children: [
                      ...
                      if (globalType == 'Individual')
                        SpeedDialChild(
                            ...
                            label: tr('Review'),
                            onTap: () async {
                              await commentDialog(context, 'Individual', 'company review', lang, '', widget.companyId.toString(), '', null);
                            })
                    ]),
                                  ...
                                  Flexible(
                                      child: SizedBox(
                                          ...
                                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                    ...
                                                    ? SizedBox(
                                                        ...
                                                        child: TextButton(
                                                            onPressed: () async {
                                                              ...
                                                              var tmp = await jobAction('Individual', 'follow', lang, uid, widget.companyId, '');
                                                              if (tmp != null && tmp['status']) {
                                                                if (profileData!.containsKey('follower') && profileData?['follower'] != null) {
                                                                  profileData!['follower'] = null;
                                                                } else {
                                                                  profileData!['follower'] = {'followed'};
                                                                }
                                                                setFollow(() {
                                                                  loadingButton = false;
                                                                });
                                                            ...
                                                            child: Text(
                                                                    profileData!.containsKey('follower') && profileData?['follower'] != null
                                                                        ? 'Unfollow'
                                                                        : 'Follow',
                                            ...
                                            if (globalType == 'Company' && widget.companyId != globalUid)
                                              SizedBox(
                                                  height: 24,
                                                  width: 60,
                                                  child: TextButton(
                                                      ...
                                                      child: Text('Message', style: TextStyle(fontSize: 13)).tr(),
                                                      style: TextButton.styleFrom(
                                                          primary: Colors.white,
                                                          backgroundColor: hexStringToColor('#6986b8'),
                                                          onSurface: Colors.grey,
                                        ...
                                        children: [
                                          ...
                                          Container(
                                              ...
                                              child: SingleChildScrollView(
                                                  ...
                                                  child: Text(
                                                      profileData?['company_overview_ar'] != null
                                                          ? lang == 'ar'
                                                              ? profileData!['company_overview_ar']
                                                              : profileData!['company_overview_en'] ?? ''
                                                          : ' - ',
                                                ...
                                                onTap: () {
                                                  if (globalType == 'Individual') {
                                                    Get.to(() => IndividualJobPage(
                                                        jobId: profileData!['jobs'][index]['id'].toString(),
                                                        jobType: profileData?['jobs'][index]['this_job_type']));
                                                  } else if (globalType == 'Company') {
                                                    Get.to(() => CompanyJobPage(jobId: profileData!['jobs'][index]['id'].toString(), jobType: 1));
                                                  }
                                                },
                                                child: Container(
                                                    ...
                                                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                                      ...
                                                      Expanded(
                                                        ...
                                                        Row(children: [
                                                          ...
                                                          SizedBox(width: 5),
                                                          Text(profileData!['jobs'][index]['country_name'] + ' - ' + profileData!['jobs'][index]['region_name'])
                                                        ]),
                                                        SizedBox(height: 5),
                                                        Row(children: [
                                                      ...
                                                      child: Column(
                                                        children: [
                                                          ListTile(
                                                              onTap: () {
                                                                if (globalType == 'Individual') {
                                                                  Get.to(() => IndividualEventPage(
                                                                        eventId: i['id'].toString(),
                                                                        eventImage: i['company_post_main_image'] ??
                                                                            "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/No_image_available.svg/1200px-No_image_available.svg.png",
                                                                      ));
                                                                } else if (globalType == 'Company') {
                                                                  Get.to(() => CompanyEventPage(
                                                                        eventId: i['id'].toString(),
                                                                        eventImage: i['company_post_main_image'] ??
                                                                            "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/No_image_available.svg/1200px-No_image_available.svg.png",
                                                                      ));
