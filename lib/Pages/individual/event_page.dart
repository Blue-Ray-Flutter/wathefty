...
class IndividualEventPage extends StatefulWidget {
  ...
  const IndividualEventPage({Key? key, required this.eventId, required this.eventImage}) : super(key: key);
          ...
          return Scaffold(
              ...
              body: StatefulBuilder(builder: (BuildContext context, StateSetter _setState) {
                return FutureBuilder<Map>(
                    future: getCompanyEvents(uid, 'Individual', lang, null, widget.eventId),
                    builder: (context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.done && snapshot.data!.isNotEmpty) {
